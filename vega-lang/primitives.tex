...
data values into visual values such as pixels or colours. By applying an
...
property values. For example, a rule might set a mark's fill colour using
scale-transformed data if predicate \texttt{A} is true, set it to yellow is
predicate \texttt{B} is true, or otherwise set the colour to grey by default.
