...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\columnwidth]{brush}
...
\begin{wrapfigure}{l}{0pt}
  \raisebox{0pt}[\dimexpr\height-0.6\baselineskip\relax]{\includegraphics[width=0.3\textwidth]{splomPixel}}
\end{wrapfigure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\columnwidth]{indexChart}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\columnwidth]{jobVoyager}
